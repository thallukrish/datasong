 ...
 *
 * New server code must import this class. Historical ProgressiveRepositoryExplorerV*
 * classes below V48 are frozen implementation layers from the prototype period;
 * no new numbered subclasses should be created.
 */
export class RepositoryExplorer extends ProgressiveRepositoryExplorerV48 {
  emptyState() {
