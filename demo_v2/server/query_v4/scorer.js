...
export async function deriveDimensions({ question, client, model, usage, log }) {
  const system = 'Identify stable business dimensions/measures/time/filter concepts required to answer the query. Return {"intent":"short","dimensions":[{"name":"canonical concept","role":"measure|dimension|time|filter|attribute|derived"}]}. Do not choose workflows, states, entities, clusters, fields, or joins.';
